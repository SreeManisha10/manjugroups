  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent transition-[width] duration-240 ease-in-out",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-20 hidden h-svh w-(--sidebar-width) transition-[left,right,width,transform] duration-240 ease-in-out md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-surface/95 backdrop-blur-sm group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-lg"
          >
            {children}
          </div>
        </div>
